module.exports = class Data1704733050125 {
    name = 'Data1704733050125'
    ...
    async up(db) {
        ...
        await db.query(`CREATE INDEX "IDX_eb89e573ed3907e7e3e4c39456" ON "paired_nft" ("fighter_position1_id") `)
        await db.query(`CREATE INDEX "IDX_2b9b2624df494935eec5dcd670" ON "paired_nft" ("fighter_position2_id") `)
        ...
        await db.query(`CREATE TABLE "nft_scan_tokens" ("id" character varying NOT NULL, "contract" text NOT NULL, "token_id" numeric, "meta" text NOT NULL, CONSTRAINT "PK_6afa224cf65859890ffcca4b244" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_2a5184b2d4d20559419990a32f" ON "nft_scan_tokens" ("contract") `)
        ...
        await db.query(`ALTER TABLE "created_voting_position" ADD CONSTRAINT "FK_c414c2384c975f34684a583cfb2" FOREIGN KEY ("staked_position_id") REFERENCES "created_staker_position"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "paired_nft" ADD CONSTRAINT "FK_eb89e573ed3907e7e3e4c394566" FOREIGN KEY ("fighter_position1_id") REFERENCES "created_staker_position"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "paired_nft" ADD CONSTRAINT "FK_2b9b2624df494935eec5dcd6708" FOREIGN KEY ("fighter_position2_id") REFERENCES "created_staker_position"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_c414c2384c975f34684a583cfb"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_eb89e573ed3907e7e3e4c39456"`)
        await db.query(`DROP INDEX "public"."IDX_2b9b2624df494935eec5dcd670"`)
        ...
        await db.query(`DROP TABLE "nft_scan_tokens"`)
        await db.query(`DROP INDEX "public"."IDX_2a5184b2d4d20559419990a32f"`)
        ...
        await db.query(`ALTER TABLE "created_voting_position" DROP CONSTRAINT "FK_c414c2384c975f34684a583cfb2"`)
        ...
        await db.query(`ALTER TABLE "paired_nft" DROP CONSTRAINT "FK_eb89e573ed3907e7e3e4c394566"`)
        await db.query(`ALTER TABLE "paired_nft" DROP CONSTRAINT "FK_2b9b2624df494935eec5dcd6708"`)
