...
export type ClaimedIncentiveRewardFromVoting0Event = ([staker: string, beneficiary: string, zooReward: ethers.BigNumber, stakingPositionId: ethers.BigNumber] & {staker: string, beneficiary: string, zooReward: ethers.BigNumber, stakingPositionId: ethers.BigNumber})
