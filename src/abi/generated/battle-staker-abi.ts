...
export const events = {
    ...
    ClaimedIncentiveRewardFromVoting: new LogEvent<([staker: string, beneficiary: string, zooReward: bigint, stakingPositionId: bigint] & {staker: string, beneficiary: string, zooReward: bigint, stakingPositionId: bigint})>(
...
export const functions = {
    ...
    batchClaimIncentiveStakerReward: new Func<[stakingPositionIds: Array<bigint>, beneficiary: string], {stakingPositionIds: Array<bigint>, beneficiary: string}, bigint>(
        abi, '0xa514e0a6'
    ),
    batchClaimRewardsFromStaking: new Func<[stakingPositionIds: Array<bigint>, beneficiary: string], {stakingPositionIds: Array<bigint>, beneficiary: string}, []>(
        abi, '0xaa7c9aa1'
    ),
    batchUnstakeNft: new Func<[stakingPositionIds: Array<bigint>], {stakingPositionIds: Array<bigint>}, []>(
        abi, '0x04f38b95'
    ),
    claimIncentiveStakerReward: new Func<[stakingPositionId: bigint, beneficiary: string], {stakingPositionId: bigint, beneficiary: string}, bigint>(
        abi, '0x3158ad6d'
    ),
    claimRewardFromStaking: new Func<[stakingPositionId: bigint, beneficiary: string], {stakingPositionId: bigint, beneficiary: string}, []>(
        abi, '0x90db6f36'
    ),
    ...
    positions: new Func<[_: bigint], {}, ([token: string, id: bigint] & {token: string, id: bigint})>(
        abi, '0x99fbab88'
    ),
    ...
    stakeNft: new Func<[token: string, id: bigint], {token: string, id: bigint}, []>(
        abi, '0x3660130b'
    ),
    ...
    unstakeNft: new Func<[stakingPositionId: bigint], {stakingPositionId: bigint}, []>(
        abi, '0x6b426000'
    ),
    zoo: new Func<[], {}, string>(
        abi, '0x7b6a8777'
...
export class Contract extends ContractBase {
    ...
    positions(arg0: bigint): Promise<([token: string, id: bigint] & {token: string, id: bigint})> {
